...
public class CAircrackWindow extends JFrame implements ActionListener, WindowListener
{
	...
	// --------------------------------------------------------------------------------
	public CAircrackWindow( String strTitle, int intWidth, int intHeight, boolean blnResizable, boolean blnExitOnClose, String strProfileFolderName )
	{
		try
		{
